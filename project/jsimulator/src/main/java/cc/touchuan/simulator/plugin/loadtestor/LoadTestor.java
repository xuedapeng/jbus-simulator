package cc.touchuan.simulator.plugin.loadtestor;
...
public class LoadTestor {
	...
	public static void main(String startId, String devcount) throws Exception {
		...
		String[] arr = {"loadtest", "device", "jbus.xxx.cn","2883",startId,devcount };
		String[] arr2 = {"loadtest", "ctrl", "tcp://pms.xxx.net:1883","xx","xxx",startId, devcount };
